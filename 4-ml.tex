...
\begin{figure}[ht]
  ...
  \caption{Illustration of the decision tree and the region splitting performed by a CART\autocite{Breiman_2017} algorithm. Adapted from an illustration of the book ``Elements of Statistical Learning''~\cite{Hastie_2009}. \todo{change}}\label{fgr:tree}
\end{figure}

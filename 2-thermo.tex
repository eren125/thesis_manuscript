...
\begin{figure}[h!]
  ...
  \caption{Scatterplots of the void fraction as a function of the LCD and labeled by the log$_10$ of the selectivity values. On the left, only the materials with a selectivity between $10$ and $40$ are considered; and on the right, selectivity values over $40$. \todo{change D\_i to D\_if}}\label{fgr:lcd_vf}
\end{figure}

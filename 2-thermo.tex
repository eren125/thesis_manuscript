...
\todo{add analysis of fernandez corr ?}
...
\begin{figure}[ht]
  ...
  \caption{Selectivity / Xe Uptake / Void Fraction \todo{Sort values by loading value}}\label{fgr:vol}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Distribution selec / uptake \todo{change label into log10(s)}}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Ditributions, selec vs sa vol \todo{change label into log10(s)} \todo{Zoom in by shortening the range of s}}
\end{figure}

\todo{3D plot  LCD / selectivity }

\todo{3D plot void / LCD / selectivity ?}

...
\begin{figure}[h!]
  ...
  \caption{On the left: scatterplot of the xenon uptake as a function of the selectivity and labeled by the values of the surface area. On the right: scatterplot of the selectivity and the surface area labeled by the quantity of xenon adsorbed. The selectivities and uptakes are all calculated by a GCMC simulation of a 20:80 Xe/Kr mixture.}\label{fgr:sa}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{3D histograms of in a bidimensional space formed by the Xe/Kr selectivity and the surface areas (on the left) and formed by the Xe/Kr selectivity and the pore void fractions (on the right). A base 10 logarithm has been applied to the selectivity values.}\label{fgr:3D_hist_sa_vol}
\end{figure}

\todo{} if now look at the 3D histogram Figure~\ref{fgr:3D_hist_sa_vol}, we can distinguish more clearly the different range of surface area values for different values of selectivities

If we now look at the 3D histogram Figure~\ref{fgr:3D_hist_sa_vol},
...
\begin{figure}[ht]
  ...
  \caption{On the left: scatterplot of the xenon uptake as a function of the selectivity and labeled by the values of the void fraction. On the right: scatterplot of the selectivity and the void fraction labeled by the quantity of xenon adsorbed. The selectivities and uptakes are all calculated by a GCMC simulation of a 20:80 Xe/Kr mixture.}\label{fgr:vol}
\end{figure}

\todo{} if now look at the 3D histogram Figure~\ref{fgr:3D_hist_sa_vol}, we can distinguish more clearly the different range of void fraction values for different values of selectivities
...
\begin{figure}[h!]
  ...
  \caption{Selectivity / Xe Uptake / LCD . values sorted by loading value}\label{fgr:vol}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{Distribution LCD / VF . $s>10$ puis $s>40$}\label{fgr:lcd_vf}
\end{figure}
...
Introduce the case of 9010 as nuclear relevant

Both selectivities are pretty close
...
\todo{Add plots for the 90 10 case ?}
...
\begin{figure}[h!]
  ...
  \caption{Distribution LCD / VF . $s>10$ puis $s>40$}\label{fgr:compo}
\end{figure}



Same region of interesting materials.\ref{fgr:compo}

Much higher capacities than 20:80


\todo{remove this after}
\clearpage
...
\todo{Even higher drops for the 90:10 composition}

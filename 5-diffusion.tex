...
\begin{figure}[ht]
  \centering
    \includegraphics[height=0.4\textwidth]{figures/5-diffusion/viz/ADOGEH_Xe.jpg}
    \includegraphics[height=0.4\textwidth]{figures/5-diffusion/viz/ADOGEH_Kr.jpg}
...
Beyond the particular cases of OQESAF and ADOGEH, other nanoporous materials have lower diffusion selectivity values. For instance, all the other materials of the Table~\ref{table:diff} have a diffusion selectivity between $0.2$ and $1.4$. Depending on the shape and the size distribution of the porous channels, we would have higher or lower values of diffusion selectivity and xenon diffusion coefficient values. 

If we take the materials with nanopores composed of pseudo-spherical cavities connected by cylindrical channels, there seems to be a correlation between the difference D$_{if}-$D$_f$ (between the LCD and the PLD) and the diffusion selectivity for the materials with an adsorption selectivity over 

\todo{plot}

\todo{Try to see if there is actually a correlation, on more }
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
      ...
      \caption{TONBII}\label{fgr:tube_cavities_b}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/5-diffusion/viz/BAEDTA01.jpg}
      \caption{BAEDTA01}\label{fgr:tube_cavities_c}
  \end{subfigure}
     \caption{Some examples of tortuous \todo{}}\label{fgr:tube_cavities}
\end{figure}

If we look at another type of shape, as we can see of the Figure~\ref{fgr:zigzag}, the channels are much more tortuose than the previous type of channel. It seems to make a ``zig-zag'' like shape. 
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
      ...
      \caption{MISQIQ}\label{fgr:zigzag_a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\textwidth}
      \centering
  ...
  \begin{subfigure}[b]{0.3\textwidth}
      ...
      \caption{VOHQIS}\label{fgr:zigzag_c}
  \end{subfigure}

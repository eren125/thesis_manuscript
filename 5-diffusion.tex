...
In our case, we want to study the transition from a pore to another one by transitioning through a channel. It is also possible to define a diffusion rate that connects the adsorption sites of the pores. \todo{Bennet-Chandler approach}
...
\begin{figure}[ht]
  \centering
    ...
    \caption{\todo{MSD, show the fit at higher time scale/ Change (10-300) yellow / Add (300-1000) il cyan}}\label{fgr:MSD_init}
\end{figure}
...
\caption{\todo{MSD, show the fit at higher time scale/ Change (10-300) yellow / Add (300-1000) il cyan}}\label{fgr:MSD_linear_init}
\end{figure}
...
\todo{1.77 +/- 0.35 10-8cm2/s} on 10 different trajectories (20\% error)

\todo{Put data for 5fs}

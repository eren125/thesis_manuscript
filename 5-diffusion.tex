...
This approach is inspiring our code to 
\todo{}
...
\begin{figure}[ht]
  \centering
    ...
    \caption{Logarithm of the xenon diffusion coefficient at infinite dilution as a function of the largest sphere diameter D$_{if}$ along a free diffusion path (left) and the xenon adsorption enthalpy (right). }\label{fgr:diff_H_lcd}
\end{figure}

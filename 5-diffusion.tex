...
If we take the materials with nanopores composed of pseudo-spherical cavities connected by cylindrical channels, we can see a clear correlation between the difference D$_{if}-$D$_f$ (between the LCD and the PLD) and the diffusion selectivity. \todo{plot} 
...
\begin{figure}[ht]
  \centering
  \includegraphics[height=0.28\textwidth]{figures/5-diffusion/viz/XUNSOQ.jpg}
  \includegraphics[height=0.28\textwidth]{figures/5-diffusion/viz/BAEDTA01.jpg}
  \includegraphics[height=0.28\textwidth]{figures/5-diffusion/viz/TONBII.jpg}
  \caption{\todo{}}\label{fgr:tube_cavities}
\end{figure}
...
\begin{figure}[ht]
  \centering
    \includegraphics[height=0.4\textwidth]{figures/5-diffusion/viz/MISQIQ.jpg}
    \includegraphics[height=0.4\textwidth]{figures/5-diffusion/viz/GUMDEZ.jpg}
    \caption{\todo{}}\label{fgr:zigzag}
\end{figure}
\todo{add a less selective one with this tortuose shepe}

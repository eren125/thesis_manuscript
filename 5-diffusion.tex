...
\begin{figure}[ht]
  \centering
    ...
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_log-diameter_ccdc_colored_s_+.jpeg}
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_log-diameter_colored_s_+.jpeg}
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=0.32\textwidth]{figures/5-diffusion/D_log-PLD_1D_chan.jpeg}
    \includegraphics[width=0.32\textwidth]{figures/5-diffusion/D_log-PLD_2D_chan.jpeg}
    \includegraphics[width=0.32\textwidth]{figures/5-diffusion/D_log-PLD_3D_chan.jpeg}
...
\begin{figure}[ht]
  \centering
    ...
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_log-vf_2_s_+.jpeg}
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_log-sa_12_s_+.jpeg}
...
\begin{figure}[ht]
  \centering
    ...
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_log-density_s_+.jpeg}
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_log-mass_s_+.jpeg}
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_log-lcd_s_+.jpeg}
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_log-H_Xe_s_+.jpeg}
...
\begin{figure}[ht]
  \centering
    ...
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_xe-s0-lcd.jpeg}
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/D_kr-s0-lcd.jpeg}
...
\begin{figure}[ht]
  \centering
    ...
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/diff_D_xekr-s0-lcd.jpeg}
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/diff_D_xekr-s0-chandim.jpeg}
    \caption{The xenon/krypton diffusion selectivity plotted against the low-pressure selectivity for a 20:80 Xe/Kr composition and color-coded by the LCD within a diffusion path D$_{if}$ (left panel) and by the average dimension of channels (right panel).}\label{fgr:perm_selec0}
\end{figure}
...
\begin{figure}[ht]
  \centering
    ...
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/diff_D_xekr-s2080-lcd.jpeg}
    \includegraphics[width=0.48\textwidth]{figures/5-diffusion/diff_D_xekr-s2080-chandim.jpeg}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/5-diffusion/difflog_barrier_Df_uff.jpeg}
    \caption{All structures}\label{fgr:barrier_diffusion_a}
\end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/5-diffusion/difflog_barrier_Df_uff_2.jpeg}
...
\begin{figure}[ht]
  \centering
    \includegraphics[width=0.6\textwidth]{figures/5-diffusion/difflog_Df-uff298K_barrier.jpeg}
...
\begin{table}[ht]
  ...
  \hline
    ...
    \hline
  \end{tabular}
  \caption{ Description of the features used in the ML model for diffusion coefficient prediction. }\label{Table:feat_diff}
\end{table}

...
\begin{figure}[ht]
  \centering
    ...
    \caption{\todo{correlation with PLD without labeling}Left: PLD/e{CCDC} and right: PLD\e{UFF}}\label{fgr:}
\end{figure}
...
\begin{figure*}[t]
\centering
  \includegraphics[width=0.8\textwidth]{figures/5-diffusion/D_log-diameter_colored_s_+.jpg}

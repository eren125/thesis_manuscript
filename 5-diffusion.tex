...
The MD trajectory can be used to generate displacement of any size $\tau$. A naive approach consists in taking $\lVert\mathbf{r}_i(\tau)-\mathbf{r}_i(0)\rVert$

\todo{explain how the trajectories can be augmented by changing the origin}

...
\begin{figure}[ht]
  ...
  \end{subfigure}
     \caption{Some examples of tortuous \todo{}}\label{fgr:porediff}
\end{figure}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
      ...
      \caption{XUNSOQ}\label{fgr:tube_cavities_a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/5-diffusion/viz/BAEDTA01.jpg}
      \caption{BAEDTA01}\label{fgr:tube_cavities_b}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/5-diffusion/viz/TONBII.jpg}
      \caption{TONBII}\label{fgr:tube_cavities_c}
  \end{subfigure}
     \caption{Some examples of tortuous \todo{}}\label{fgr:tube_cavities}
\end{figure}

Beyond consideration on the purely diffusion properties, the rather high adsorption selectivity coupled with very little diffusion limitations, make these materials extremely interesting for further study. The material BAEDTA01 has already been mentioned in the study on the selectivity drop due to pressure condition changes, the Figure~\ref{fgr:tube_cavities_b} sheds a brighter light on the origins of this selectivity drop, we can clearly see the two different adsorption sites (one narrower than the other) --- the narrower site is the one giving the very high low-pressure selectivity. The other two materials TONBII and XUNSOQ have a rather stable selectivity value between the low pressure and the ambient pressure cases. If we compare to the KAXQIL structure given by a previous high-throughput screening~\autocite{Simon_2015}, the diffusion coefficeints are much higher and the problem of a potential diffusion limitation is solved, the selectivity values of these materials are however yet to be confirmed. The very high selectivity value found for KAXQIL xas for instance found to be much lower afterward.
\todo{mettre KAXQIL dans le tableau}
\todo{discuss about capacity ?}


\todo{HERE}
If we look at another type of shape, as we can see of the Figure~\ref{fgr:zigzag}, the channels are much more tortuous than the previous type of channel. It seems to make a ``zig-zag'' like shape. 
...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
      ...
      \caption{VOHQIS}\label{fgr:zigzag_a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/5-diffusion/viz/GUMDEZ.jpg}
      \caption{GUMDEZ}\label{fgr:zigzag_b}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.3\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/5-diffusion/viz/MISQIQ.jpg}
      \caption{MISQIQ}\label{fgr:zigzag_c}
  \end{subfigure}
     \caption{Some examples of tortuous \todo{}}\label{fgr:zigzag}
\end{figure}

\todo{add a less selective one with this tortuous shape}

Go beyond this study by quantitatively quantify tortuosity and try to find patterns in the correlations.

...
\todo{Can be used in breakthrough simulations using RUPTURA\autocite{Sharma_2023} and equations that link the diffusion coefficient to the axial dispersion coefficient a key parameter in the breakthrough modeling.}

...
\begin{document}
    ...
    \vspace{2cm}
    \epigraph{\itshape L'instinct achevé est une faculté d'utiliser et même de construire des instruments organisés ; l'intelligence achevée est la faculté de fabriquer et d'employer des instruments inorganisés.}{Henri \textsc{Bergson}\\ L'évolution créatrice}
    \vfill
    \clearpage

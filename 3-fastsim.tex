...
\todo{explain the parameters behind the blocking: mu paramater similar to surface + energy threshhold $E\e{th}$}
...
\begin{figure}[ht]
  \centering
    ...
    \caption{Comparison of the adsorption enthalpies calculated by the optimized grid energy sampling for a \SI{0.12}{\angstrom} spacing and an energy threshold of \SI{100}{\kilo\joule\per\mole}
      Perfect accordance except for issues of small difference of structure due to symmetry conversion}\label{fgr:grid_widom}
\end{figure}

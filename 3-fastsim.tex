...
\begin{figure}[ht]
  \centering
    ...
    \caption{Comparison of the RMSE on Xe adsorption enthalpy and the average CPU time required to run a simulation on a structure of CoRE MOF 2019 (LCD\e{CCDC} $\geq$ \SI{3.7}{\angstrom}) for different sampling techniques (Widom, Voronoi, RAESS and GrAED). The values are reported in Table~\ref{tab:grid}. }\label{fgr:grid_perfomance}
\end{figure}

...
\todo{describe, surtout sur les matériaux qui sont potentiellement touché par le drop, info > }
...
\todo{permet de sitinguer entre les différentes structures avec un grande diversité de pores et connaitre ce qui favorise le drop ou pas}

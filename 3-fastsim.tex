...
\begin{table}[ht]
  ...
  \begin{tabular}{|l|r|r|}
    ...
    \hline
    Grid -- naive -- \SI{0.1}{\angstrom} &  71.3 & 0.03  \\[0.5mm]
    Grid -- blocking -- \SI{0.1}{\angstrom} &  18.8 & 0.03  \\
    Grid -- symmetry -- \SI{0.1}{\angstrom} &  16.8 & 0.02  \\
    Grid -- fast -- \SI{0.1}{\angstrom} &  4.8 & 0.02  \\
    % Grid -- fast -- \SI{0.12}{\angstrom} &  2.9 & 0.02  \\

...
With this Becker et al. carried out an interesting study on a series of MOF materials with a high density of open-metal sites, the M-MOF-74 with M = Co, Cr, Cu, Fe, Mg, Mn, Ni, Ti, V, and Zn.\autocite{Becker_2017} The authors found that by adding a potential induced by the surrounding partial charges to a modified LJ potential, they could reproduce the \ce{CO2} and \ce{CH4} experimental isotherm data for this series of MOFs. They also show that the standard UFF forcefield does no describe the adsorption behavior of \ce{CO2} on the open-metal sites, hence missing out on a strong adsorption site at infinite dilution. 
